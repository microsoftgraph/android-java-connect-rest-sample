...
* A Microsoft Azure tenant to register your application. Microsoft Azure Active Directory provides identity services that applications use for authentication and authorization. A trial subscription can be acquired here: [Microsoft Azure](https://account.windowsazure.com/SignUp).
...
3. Start Android Studio.
	...
	2. Browse to your local repository and select the O365-Android-Unified-API-Connect project. Click **OK**.
